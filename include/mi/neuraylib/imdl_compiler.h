...
public:
    ...
    /// - \c "glsl_version": Specifies the GLSL target version. Possible values:
    ///   \c "150", \c "330", \c "400", \c "410", \c "420", \c "430", \c "440", \c "450".
    ///   Default: \c "330".
    /// - \c "glsl_profile": Specifies the GLSL target profile. Possible values:
    ///   \c "core", \c "es", \c "compatibility".
    ///   Default: \c "core".
    /// - \c "glsl_include_uniform_state": If true, object_id will be included in the state
    ...
    ///   Default: \c "1024".
    /// - \c "glsl_place_uniforms_into_ssbo": If true, all generated uniform inputs will be
