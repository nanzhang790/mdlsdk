...
public:
    ...
    enum Semantics
    {
        ...
        DS_INTRINSIC_NVIDIA_DF_FIRST = 0x0700,

        /// The nvidia::df::ashikhmin_shirley_glossy_bsdf() function.
        DS_INTRINSIC_NVIDIA_DF_ASHIKHMIN_SHIRLEY_GLOSSY_BSDF = DS_INTRINSIC_NVIDIA_DF_FIRST,
        ...
        DS_INTRINSIC_NVIDIA_DF_MICROFACET_SIN_K_SMITH_BSDF,
        DS_INTRINSIC_NVIDIA_DF_MICROFACET_SIN_K_VC_BSDF,

        DS_INTRINSIC_NVIDIA_DF_LAST = DS_INTRINSIC_NVIDIA_DF_MICROFACET_SIN_K_VC_BSDF,
